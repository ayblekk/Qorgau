...
- Russian as primary development language
- Kazakh translations required for MVP
- Explanations generated by the model or templates must support both languages cleanly
